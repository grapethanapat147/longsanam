    ...
    <div className="flex min-h-dvh flex-col">
      ...
      <main className="mx-auto flex w-full max-w-md flex-1 flex-col justify-center px-4 py-10">
        ...
        <Card className="px-6 py-6">
          <h1 className="text-xl font-bold text-ink-900 dark:text-white">{t.auth.signUpTitle}</h1>
          <SignUpForm />
        </Card>

        <p className="mt-4 text-center text-sm text-ink-600 dark:text-ink-300">
          <Link href="/auth/sign-in" className="font-semibold text-brand-700 hover:underline dark:text-brand-300">
            {t.auth.toSignIn}
          </Link>
        </p>
      </main>
