      ...
      <div className="grid gap-5 lg:grid-cols-[1fr_20rem]">
        <div className="space-y-4">
          <Card className="px-5 py-6 text-center">
            <p className="text-sm text-ink-500">{t.waitlistPage.position}</p>
            ...
            {waitlistEntry.status === 'promoted' && waitlistEntry.promotion_expires_at ? (
              ...
              <p className="mx-auto mt-3 max-w-sm text-sm text-ink-600">{t.waitlistPage.explain}</p>
            )}
          </Card>
          ...
          <Card className="px-5 py-4">
            ...
            <dl className="mt-3 space-y-2 text-sm">
              ...
              <div className="flex justify-between gap-4">
                <dt className="text-ink-500">ผู้เล่น</dt>
                <dd className="text-right font-medium text-ink-900">
