...
export const t = {
  ...
  badges: {
    title: 'เหรียญสะสม',
    note: 'ได้จากผลแมตช์ที่ยืนยันแล้วเท่านั้น ไม่เกี่ยวกับคะแนนฝีมือและเครดิตการจ่ายเงิน',
    empty: 'ยังไม่มีเหรียญ ลงแข่งสักรายการแล้วกลับมาดูใหม่',
  },
  ...
  tournaments: {
    ...
    matchDateField: 'วันแข่ง',
    startTimeField: 'เริ่มกี่โมง',
    endTimeField: 'เล่นถึงกี่โมง',
    deadlineDateField: 'รับสมัครถึงวันไหน',
    deadlineDateHint: 'ต้องเป็นวันก่อนวันแข่ง · ถ้าทีมไม่ครบภายในวันนี้ ทุกก๊วนได้เงินคืนเต็ม',
    quickWeek: '1 สัปดาห์ก่อนแข่ง',
    quickTwoWeeks: '2 สัปดาห์ก่อนแข่ง',
    pickMatchDateFirst: 'เลือกวันแข่งก่อน แล้วปุ่มลัดจะกรอกให้',
    endBeforeStart: 'เวลาเล่นถึงต้องอยู่หลังเวลาเริ่ม',
    deadlineNotBeforeMatch: 'วันรับสมัครต้องอยู่ก่อนวันแข่ง อย่างน้อยหนึ่งวัน',
    dateRequired: 'ยังไม่ได้เลือกวันแข่ง หรือวันรับสมัคร',
    summaryTitle: 'ทวนอีกรอบก่อนสร้าง',
    summary: (d: string, a: string, b: string, dl: string) =>
      `แข่ง ${d} เวลา ${a}–${b} น. · รับสมัครถึง ${dl}`,
    ...
    standingsHint: 'นับเฉพาะแมตช์ที่ยืนยันแล้ว เรียงด้วยจำนวนชนะ แล้วค่อยผลต่างแต้ม',
    standingsPlayed: 'แข่ง',
    standingsWins: 'ชนะ',
    standingsDiff: 'ได้เสีย',
    completedNote: 'งานนี้จบแล้ว',
    championIs: (name: string) => `แชมป์คือ ${name}`,
    championTied: 'สองอันดับแรกเสมอกันทุกเกณฑ์ ยังตัดสินแชมป์ไม่ได้',
    championNone: 'ไม่มีผลแมตช์ที่ยืนยัน จึงไม่มีแชมป์',
    badgesEarnedHere: 'ได้จากงานนี้',
  ...
  matches: {
    ...
    noOpponentLeft: 'ไม่มีคู่แข่งให้เลือก — คนในก๊วนตรงข้ามเป็นคนเดียวกับที่ลงฝั่งนี้อยู่',
    sideAPlayer: 'ผู้เล่นฝั่งเรา',
    sideBPlayer: 'ผู้เล่นฝั่งตรงข้าม',
    scoreAField: 'สกอร์ฝั่งเรา',
    scoreBField: 'สกอร์ฝั่งตรงข้าม',
