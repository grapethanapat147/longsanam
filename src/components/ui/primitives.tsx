...
const buttonVariants: Record<ButtonVariant, string> = {
  ...
  /* hover เข้มลง ไม่ใช่สว่างขึ้น — ขาวบน brand-400 จะยิ่งตกเกณฑ์กว่า 500 (LSN-0037) */
  primary: 'bg-brand-600 text-on-brand shadow-line hover:bg-brand-700 active:bg-brand-600',
...
const chipTones: Record<ChipTone, { chip: string; dot: string }> = {
  ...
  brand: { chip: 'bg-brand-600 text-on-brand', dot: 'bg-on-brand' },
